...
const UserProfile = () => {
  ...
  const getProfilePicture = async () => {
    ...
    axios
      .get(api.API_URL + "/api/getProfilePicture/" + obj.data.id)
      .then((res) => {
        if (res.data) {
  ...
  const uploadImage = () => {
    ...
    axios
      .post(api.API_URL + "/api/uploadProfilePicture", formData, {
        headers: {
  ...
  const validation = useFormik({
    ...
    onSubmit: (values) => {
      axios
        .post(api.API_URL + "/api/updateUserProfile", {
          isNew: false,
          id: idx,
            ...
            <Col lg="12">
              <Card>
                <CardBody>
                  ...
                  <div
                    className="mt-3"
                    style={{ display: !isImageUpload ? "block" : "none" }}
                  >
                    <button
                  ...
                  <Row className="mt-2">
                    ...
                    <Col xl={4}>
                      <div
                        ...
                        className="mt-4 flex items-center text-center justify-content-center"
                      >
                        <Button
                          color="primary"
