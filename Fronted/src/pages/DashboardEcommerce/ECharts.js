...
//StepLine Chart
const StepLineChart = ({ dataColors, type, voltCurrentData }) => {
    ...
    var option = {
        ...
        color: ['#0e1e41', '#0e1e41', '#0e1e41'],
        series: [{
            name: type == "volt" ? 'Battery Voltage' : 'Battery Current',
            type: 'line',
            step: 'start',
            data: type == "volt" ? voltCurrentData.btyVolt : voltCurrentData.btyCur
        },
        {
            name: type == "volt" ? 'Solar Voltage' : 'Solar Current',
            type: 'line',
            step: 'end',
            data: type == "volt" ? voltCurrentData.slrVolt : voltCurrentData.slrCur
        }
        ]
    };
...
//Gauge Chart
const GaugeChart = ({ dataColors, mydata, label }) => {
