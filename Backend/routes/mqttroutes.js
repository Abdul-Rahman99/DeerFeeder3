...
router.get('/api/getAllNotificationsList', sessionMiddleware, getAllNotificationsList)

// BirdsFeed
//router.get('/api/getDevices',sessionMiddleware ,getDevices)
router.get('/api/getDevices', (req, res, next) => {
...
router.get('/api/getDeviceDetails/:feederId', sessionMiddleware, getDeviceDetails)
router.get('/api/getFeedDateTimes/:feederId', sessionMiddleware, getFeedDateTimes)

router.get('/api/getBirdsDataForGraph/:feederId/:datefrom?/:sfilter?', sessionMiddleware, getBirdsDataForGraph)
//router.get('/api/getBirdsDataForAdmin/:page?/:pageSize?',sessionMiddleware, getBirdsDataForAdmin)
router.get('/api/getBirdsDataForAdmin/:page?/:pageSize?', (req, res, next) => {
...
router.get("/api/getRoles", (req, res, next) => {
...
router.get("/api/getPermissions", (req, res, next) => {
    sessionMiddleware(req, res, next, 'manage-permissions');
}, getPermissions);
router.delete("/api/deletePermission/:permission_id", sessionMiddleware, deletePermission);

// User Role management APIs
//router.get("/api/getUserRole",sessionMiddleware, getUserRole);
router.get("/api/getUserRole", (req, res, next) => {
...
router.post("/api/updateScheduleStatus/:userId/:feederId", updateScheduleStatus);
router.post("/api/UpdateScheduleStopStatus/:userId/:feederId", UpdateScheduleStopStatus);
